...
import TextInput from '../../Componentes/TextoInput';
...
export default function Usuario(props) {
    ...
    const salvar = async () => {
        if (dadosNome.length <= 0) {
            ...
            if (editingId !== null) {
                alterarUsuario(editingId, dadosNome, dadosCpf, dadosRg, dadosDataNascimento);
                setEditingId(null);
            } else {
                addUsuario(dadosNome, dadosCpf, dadosRg, dadosDataNascimento);
            }
            setDadosNome('');
            setDadosCpf('');
            setDadosRg('');
    ...
    return(
        <View style={styles.container}>
            ...
            <View style={Estilos.card_dados}>
                ...
                <TextInput estilo={Estilos.input}
